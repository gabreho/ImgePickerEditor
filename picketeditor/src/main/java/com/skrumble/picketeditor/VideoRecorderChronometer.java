...
@RemoteView
public class VideoRecorderChronometer extends AppCompatTextView {
    private static final String TAG = "Chronometer";

    public interface OnChronometerTickListener {

        void onChronometerTick(VideoRecorderChronometer chronometer);
    ...
    public VideoRecorderChronometer(Context context) {
        this(context, null, 0);
    }
     ...
     */
    public VideoRecorderChronometer(Context context, AttributeSet attrs) {
     ...
     * Sets the base to the current time.
     */
    public VideoRecorderChronometer(Context context, AttributeSet attrs, int defStyleAttr) {
